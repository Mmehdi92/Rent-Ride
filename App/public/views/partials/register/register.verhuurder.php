...
<div class="w-full max-w-4xl mx-auto mt-10">
    ...
    <form class="grid grid-cols-2 gap-6 p-8 bg-white rounded-lg" method="POST" action="/auth/register/verhuurder">
        ...
        <div class="flex flex-col space-y-2">
            ...
            <input type="number" name="kvk" id="kvk" value="<?= $user['kvk'] ?? '' ?>" class="p-2 border rounded-md focus:outline-blue-700 focus:bg-yellow-400 focus:font-semibold">
        </div>
        <div class="flex flex-col space-y-2">
            <label for="telefoon" class="text-xl font-semibold">Telefoonnummer</label>
            <input type="number" name="telefoon" value="<?= $user['telefoon'] ?? '' ?>" id="telefoon" class="p-2 border rounded-md focus:outline-blue-700 focus:bg-yellow-400 focus:font-semibold">
        </div>
        <div class="flex flex-col space-y-2">
            <label for="ondernemingsnaam" class="text-xl font-semibold">Ondernemingsnaam</label>
            <input type="text" name="ondernemingsnaam" value="<?= $user['ondernemingsnaam'] ?? '' ?>" id="ondernemingsnaam" class="p-2 border rounded-md focus:outline-blue-700 focus:bg-yellow-400 focus:font-semibold">
        </div>
