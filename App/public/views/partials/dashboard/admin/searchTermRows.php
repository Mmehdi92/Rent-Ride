        ...
        <div class="flex flex-col w-full space-y-2">
            ...
            <div class="flex flex-row mx-auto space-x-24 ">
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    <?php foreach ($searchTermList as $searchTerm) : ?>

                        <div class="flex items-center p-4 bg-gray-100 border rounded-lg">
                            <img src="../../../SVG Icons/Message Icon.svg" alt="Car Icon" class="w-10 h-10">
                            <div class="flex w-2/3 justify-evenly">
                                <p class="flex-1 text-center"><?= $searchTerm->getProperty('zoekterm') ?></p>
                                <p class="flex-1 text-center"><?= $searchTerm->getProperty('created_at') ?></p>
                            ...
                            <div class="flex flex-row ml-auto space-x-6">
                                ...
                                <form method="POST" action="/listing-searchterm/<?= $searchTerm->getProperty('id') ?>">
