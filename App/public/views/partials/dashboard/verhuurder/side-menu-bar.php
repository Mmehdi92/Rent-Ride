  ...
  <div class="flex flex-col justify-between min-h-screen p-4 mr-8 border rounded-lg w-fit">
                <div class="flex flex-col space-y-2">
                    ...
                    <a class="p-1 text-sm duration-300 bg-green-400 border rounded-md hover:outline hover:bg-white hover:font-semibold hover:text-black-400" href="/listing-car">Mijn Voertuigen</a>
